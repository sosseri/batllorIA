...
if "spoken_text" not in st.session_state:
    ...
    spoken = params.get("spoken_text", [""])[0]
    st.session_state.spoken_text = spoken or ""
    st.session_state.input_text = spoken or ""
    st.experimental_set_query_params()  # pulisce l'URL param
